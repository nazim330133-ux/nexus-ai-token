...
export interface NexusAIInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_SUPPLY"
      | "allowance"
...
export interface NexusAI extends BaseContract {
  connect(runner?: ContractRunner | null): NexusAI;
  waitForDeployment(): Promise<this>;

  interface: NexusAIInterface;
